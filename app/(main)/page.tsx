...
export default function Home() {
	return (
		<>
			...
			<span className="bg-background-secondary-500 border-foreground-500 absolute -z-10 col-span-3 row-span-2 row-start-5 h-full w-full sm:col-span-full sm:col-start-1 sm:row-start-5 xl:col-span-2 xl:col-start-4 xl:row-span-4 xl:row-start-1 xl:border-l" />
			...
			<div className="border-foreground-500 flex items-center justify-center sm:col-start-3 sm:row-start-5 sm:border-r sm:border-b xl:col-span-2 xl:col-start-4 xl:row-start-3 xl:border-r-0">
			...
			<div className="border-foreground-500 relative col-span-2 h-[322px] border-l sm:col-span-1 sm:col-start-2 sm:row-span-2 sm:row-start-5 sm:border-r sm:border-b xl:col-start-4 xl:row-span-1 xl:row-start-2 xl:h-auto">
